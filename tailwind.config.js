...
module.exports = {
  ...
  theme: {
    extend: {
      backgroundImage: {
        'header-primary': 'url(/images/bg/bg-header-primary.jpg)',
        'header-emerald': 'url(/images/bg/bg-header-emerald.jpg)',
        'header-amber': 'url(/images/bg/bg-header-amber.jpg)',
        'header-rose': 'url(/images/bg/bg-header-rose.jpg)',
      },
      fontFamily: {
